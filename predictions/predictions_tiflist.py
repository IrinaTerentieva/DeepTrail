...
class UNetPredictionFlow(FlowSpec):
    ...
    def start(self):
        ...
        self.image_paths = ['/home/irina.terenteva/HumanFootprint/DATA/DTM/GrizzlyCreekSite_ndtm.tif',
                            '/home/irina.terenteva/HumanFootprint/DATA/DTM/PA2-E1(East)-AtticCreekRoadSite_ndtm.tif',
                            '/home/irina.terenteva/HumanFootprint/DATA/DTM/PA2-W2(West)-RestoredWellpadAccess-SiteB_ndtm.tif',
                            '/home/irina.terenteva/HumanFootprint/DATA/DTM/PA2-E2(East)-BeattonRiver-SiteB_ndtm.tif',
                            '/home/irina.terenteva/HumanFootprint/DATA/DTM/PA2-W2(West)-RestoredWellpadAccess-SiteA_ndtm.tif',
                            '/home/irina.terenteva/HumanFootprint/DATA/DTM/PA2-E2(East)-BeattonRiver-SiteA_ndtm.tif',
                            '/home/irina.terenteva/HumanFootprint/DATA/DTM/PA1-PinkMtnRanchRestored-SiteA_ndtm.tif'
            ]
        ...
        print(f"Input Image Path: {self.image_paths}", flush=True)
    ...
    def predict_and_save(self):
        ...
        for image_path in self.image_paths:
            ...
            print(f'Predicting and saving for image: {image_path} -> {output_path}', flush=True)
