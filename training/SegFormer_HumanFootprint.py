...
from utils_segformer import (
    TrailsDataset, EarlyStopping, build_augmentations, calculate_statistics,
...
def main():
    ...
    dataset_path = "/media/irina/My Book/Surmont/TrainingCNN/synth_tracks_1024px_10cm_curves"
